...
margin-left:40px
                ...
                <b:if cond='data:view.isLayoutMode or data:widgets any (w =&gt; w.sectionId == &quot;search_top&quot;)'>
                  <div class='search'>
                    ...
                    <b:section id='search_top' name='Search (Top)' showaddelement='false'>
                      <b:widget id='BlogSearch1' locked='true' title='Pesquisar este blog' type='BlogSearch' visible='true'>
                        <b:includable id='main'>
          ...
          <input class='search-action flat-button' expr:value='data:messages.search.escaped' type='submit'/>
                ...
                <div class='blog-name container'>
                  <b:section class='container' id='header' name='Header' showaddelement='false'>
                    <b:widget id='Header1' locked='true' title='ROBIN AIRDRAK TUTORIAIS (Cabeçalho)' type='Header' visible='true'>
                      <b:widget-settings>
          ...
          <div class='snippet-thumbnail'>
            <b:with value='data:post.featuredImage.isYoutube                            ? resizeImage(data:post.featuredImage.youtubeMaxResDefaultUrl, 945, &quot;945:600&quot;)                            : &quot;&quot;' var='highRes'>
              <b:include data='{                                  image: data:post.featuredImage,                                  imageSizes: [256, 512, 945, 1684],                                  imageRatio: &quot;945:600&quot;,                                  sourceSizes: &quot;(min-width: 954px) 842px, (min-width: 801px) calc(100vw - 112px), calc(100vw - 64px)&quot;,                                  enhancedSourceset: data:highRes                                }' name='responsiveImage'/>
                  ...
                  <b:widget id='Blog1' locked='true' title='Postagens no blog' type='Blog' visible='true'>
                    <b:widget-settings>
                      <b:widget-setting name='commentLabel'>comments</b:widget-setting>
                      <b:widget-setting name='showShareButtons'>true</b:widget-setting>
                      <b:widget-setting name='authorLabel'>BY RTMODS</b:widget-setting>
                      <b:widget-setting name='style.unittype'>TextAndImage</b:widget-setting>
  ...
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='Stats1' locked='false' title='Total de visualizações de página' type='Stats' visible='true'>
            <b:widget-settings>
  ...
  <div class='widget-content'>
    ...
    <div expr:id='data:widget.instanceId + &quot;_content&quot;' style='display: none;'>
      ...
      <span expr:class='&quot;counter-wrapper &quot; + (data:showGraphicalCounter ? &quot;graph-counter-wrapper&quot; : &quot;text-counter-wrapper&quot;)' expr:id='data:widget.instanceId + &quot;_totalCount&quot;'>
          ...
          <b:widget id='Header2' locked='false' title='ROBIN AIRDRAK TUTORIAIS (Cabeçalho)' type='Header' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='displayUrl'/>
              <b:widget-setting name='displayHeight'>0</b:widget-setting>
              <b:widget-setting name='sectionWidth'>-1</b:widget-setting>
  ...
  <script src='//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit'/>
          ...
          <b:widget id='Followers1' locked='false' title='Seguidores' type='Followers' visible='true'>
            <b:widget-settings>
              ...
              <b:widget-setting name='endcapTextColor'>#9ba2a8</b:widget-setting>
              <b:widget-setting name='contentTextColor'>#9ba2a8</b:widget-setting>
              <b:widget-setting name='contentSecondaryLinkColor'>#FFFFFF</b:widget-setting>
              <b:widget-setting name='endcapLinkColor'>#2196f3</b:widget-setting>
              <b:widget-setting name='contentLinkColor'>#2196f3</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
  ...
  <div class='widget-content'>
    ...
    <b:include name='quickedit'/>
          ...
          <b:widget id='Profile1' locked='true' title='Quem sou eu' type='Profile' visible='false'>
            <b:widget-settings>
  ...
  <ul class='posts hierarchy'>
    <b:loop values='data:posts' var='post'>
      <li>
        ...
        <b:widget id='Label1' locked='false' title='Marcadores' type='Label' visible='false'>
          <b:widget-settings>
